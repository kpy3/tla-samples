...
\@x{}\moduleLeftDash\@xx{ {\MODULE} WolfGoatCabbage}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 But crossing the
 river by boat, the farmer could carry only himself and a single one of his
 purchases: the wolf,
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The farmer\mbox{'}s challenge was to carry himself and his purchases to the
...
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{leftB} - river bank where farmer came,
 \ensuremath{rightB} - far river bank,
 \ensuremath{boatPos} - boat position
\end{cpar}%
\end{lcom}%
\@x{ {\VARIABLES} leftB ,\, rightB ,\, boatPos}%
\@x{ vars \.{\defeq} {\langle} leftB ,\, rightB ,\, boatPos {\rangle}}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{9.74} boatPos \.{\in} \{\@w{l} ,\,\@w{r} \}}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} \A\, x \.{\in} leftB \.{:} x \.{\in}
 \{\@w{w} ,\,\@w{g} ,\,\@w{c} \}}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} \A\, x \.{\in} rightB \.{:} x \.{\in}
 \{\@w{w} ,\,\@w{g} ,\,\@w{c} \}}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} leftB \.{=} \{\@w{w} ,\,\@w{g} ,\,\@w{c} \}}%
\@x{\@s{16.4} \.{\land} rightB \.{=} \{ \}}%
\@x{\@s{16.4} \.{\land} boatPos \.{=}\@w{l}}%
\@pvspace{8.0pt}%
\@x{ CanCross ( place ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} {\lnot} ( \{\@w{w} ,\,\@w{g} \} \.{\subseteq} place
 )}%
 \@x{\@s{16.4} \.{\land} {\lnot} ( \{\@w{g} ,\,\@w{c} \}\@s{2.38}
 \.{\subseteq} place )}%
\@pvspace{8.0pt}%
\@x{ GotoRight \.{\defeq}}%
\@x{\@s{16.4} \.{\land} boatPos \.{=}\@w{l}}%
\@x{\@s{16.4} \.{\land} CanCross ( leftB )}%
\@x{\@s{16.4} \.{\land} boatPos \.{'} \.{=}\@w{r}}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} leftB ,\, rightB {\rangle}}%
\@pvspace{8.0pt}%
\@x{ GotoLeft \.{\defeq}}%
\@x{\@s{16.4} \.{\land} boatPos \.{=}\@w{r}}%
\@x{\@s{16.4} \.{\land} CanCross ( rightB )}%
\@x{\@s{16.4} \.{\land} boatPos \.{'} \.{=}\@w{l}}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} leftB ,\, rightB {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Move ( x ,\, from ,\, to ) \.{\defeq}}%
\@x{\@s{24.02} \.{\land} from \.{'} \.{=} from \.{\,\backslash\,} \{ x \}}%
\@x{\@s{24.02} \.{\land} to \.{'} \.{=} to \.{\cup} \{ x \}}%
\@pvspace{8.0pt}%
\@x{ MovetoRight ( x ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} boatPos \.{=}\@w{l}}%
\@x{\@s{16.4} \.{\land} CanCross ( leftB \.{\,\backslash\,} \{ x \} )}%
\@x{\@s{16.4} \.{\land} boatPos \.{'} \.{=}\@w{r}}%
\@x{\@s{16.4} \.{\land} Move ( x ,\, leftB ,\, rightB )}%
\@pvspace{8.0pt}%
\@x{ MovetoLeft ( x )\@s{4.1} \.{\defeq}}%
\@x{\@s{16.4} \.{\land} boatPos \.{=}\@w{r}}%
\@x{\@s{16.4} \.{\land} CanCross ( rightB \.{\,\backslash\,} \{ x \} )}%
\@x{\@s{16.4} \.{\land} boatPos \.{'} \.{=}\@w{l}}%
\@x{\@s{16.4} \.{\land} Move ( x ,\, rightB ,\, leftB )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} \E\, x \.{\in} leftB \.{:} MovetoRight ( x )}%
\@x{\@s{16.4} \.{\lor} GotoRight}%
\@x{\@s{16.4} \.{\lor} \E\, x \.{\in} rightB \.{:} MovetoLeft ( x )}%
\@x{\@s{16.4} \.{\lor} GotoLeft}%
\@pvspace{8.0pt}%
 \@x{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} vars
 {\rangle}}}%
\@pvspace{8.0pt}%
\@x{ {\THEOREM} Spec \.{\implies} TypeOK}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 10 15:23:16 \ensuremath{MSK} 2021 by \ensuremath{s.elin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Sep} 05 09:59:38
 \ensuremath{MSK} 2021 by \ensuremath{s.elin
}%
\end{cpar}%
\end{lcom}%
\end{document}
